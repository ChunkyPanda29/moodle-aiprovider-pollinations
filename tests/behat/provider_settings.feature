...
Feature: Pollinations AI provider settings
  ...
  Scenario: View the Pollinations provider settings page
    When I navigate to "Site administration > Plugins > AI providers > Pollinations AI provider" in site administration
  ...
  Scenario: Enable and configure rate limiting
    ...
    And I navigate to "Site administration > Plugins > AI providers > Pollinations AI provider" in site administration
